...
#---- RipGrep ---
alias rgsearch-fzf='rg "pattern" --color=always | fzf --ansi --height 40% --layout=reverse --border --preview "bat --color=always {}"'alias rgf='rg --files | fzf --height 40% --layout=reverse --border --preview "bat --color=always {}"'
